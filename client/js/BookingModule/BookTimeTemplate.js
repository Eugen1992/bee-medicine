        ...
        '<div class="js-book-form bookForm">',
            ...
            '<div class="bookForm-form" data-form="book">',
              ...
              '<div class="bookForm-inputWrapper">',
                ...
                '<select class="js-form-date bookForm-select bookForm-input--small" name="year"  placeholder="Год" >',
                ...
                '<div class="bookForm-inputWrapper">',
                  ...
                  '<input class="js-form-date bookForm-select bookForm-input--small" name="time" type="number" value="20"/>',
                '</div>',
